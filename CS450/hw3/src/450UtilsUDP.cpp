...
Packet * makePacket(char * relay, char * hostip, const char * filename, uint16_t from_Port, uint16_t to_Port, int packetType, int saveFile, int nTotalBytes) {
    ...
    strcpy(packet->header.filename, filename);
